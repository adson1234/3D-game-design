...
bool BasicTutorial_00::keyPressed( const OIS::KeyEvent &arg )
{
    ...
    if (arg.key == OIS::KC_2 ) {
		...
		mCameraMan->getCamera()
            ->setPosition(Vector3(98.14,	-450.69,	964.20));
        mCameraMan->getCamera()
            ->setDirection(Vector3(-0.01,	999,	-0.95));
    ...
    if (arg.key == OIS::KC_5 ) {
        // add your own stuff
		mCameraMan->getCamera()
            ->setPosition(Vector3(191.94,822.63,30.79));
        mCameraMan->getCamera()
            ->setDirection(Vector3(10.00,-0.99,-0.11));
		mCameraManArr[1]->getCamera()
            ->setPosition(Vector3(119.94,822.63,30.79));
        mCameraManArr[1]->getCamera()
            ->setDirection(Vector3(10.00,-0.99,-0.11));
        //19.94	822.63	30.79
        //0.00	-0.99	-0.11
